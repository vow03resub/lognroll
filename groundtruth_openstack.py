...
"DEBUG ovsdbapp.backend.ovs_idl.vlog \[.*\] \[POLLIN\] on fd .* {{\(pid=.*\) __log_wakeup /usr/local/lib/python2.7/dist\-packages/ovs/poller.py:246}}",
...
"DEBUG oslo_concurrency.processutils \[.*\] Running cmd \(subprocess\): sudo cinder-rootwrap /etc/cinder/rootwrap.conf env LC_ALL=C vgs \-\-noheadings \-\-unit=g \-o name,size,free,lv_count,uuid \-\-separator : \-\-nosuffix stack\-volumes\-lvmdriver\-1 {{\(pid=.*\) execute /usr/local/lib/python2.7/dist\-packages/oslo_concurrency/processutils.py:355}}",
"DEBUG oslo_concurrency.processutils \[.*\] Running cmd \(subprocess\): sudo cinder-rootwrap /etc/cinder/rootwrap.conf env LC_ALL=C lvs \-\-noheadings \-\-unit=g \-o vg_name,name,size \-\-nosuffix stack\-volumes\-lvmdriver\-1 {{\(pid=.*\) execute /usr/local/lib/python2.7/dist-packages/oslo_concurrency/processutils.py:355}}",
"DEBUG nova.compute.manager \[.*\] CONF\..* <= 0, skipping\.\.\. {{\(pid=.*\) _reclaim_queued_deletes /opt/stack/nova/nova/compute/manager.py:6560}}",
...
"INFO keystone.common.wsgi \[.*\] POST http://.*/identity/v3/auth/tokens",
"DEBUG ovsdbapp.backend.ovs_idl.vlog \[.*\] .* timeout {{\(pid=.*\) __log_wakeup /usr/local/lib/python2.7/dist-packages/ovs/poller.py:231}}",
